...
class EnhancedQC:
        ...
        try:
            ...
            <body>
                ...
                <div class="section">
                    ...
                    {"<p class='good'>✅ All checks passed - Data is compatible with tensorQTL</p>" if not issues else 
    ...
    def check_phenotype_file_quality(self, pheno_file, pheno_type):
        ...
        try:
            ...
            logger.info(f"    ✅ {pheno_type} file: {df.shape[0]} features, {df.shape[1]} samples - {quality_info['checks_passed']}/7 checks passed")
            return quality_info
    ...
    def check_covariates_file_quality(self, covariates_file):
        ...
        try:
            ...
            logger.info(f"    ✅ Covariates file: {df.shape[0]} covariates, {df.shape[1]} samples - {quality_info['checks_passed']}/6 checks passed")
            return quality_info
